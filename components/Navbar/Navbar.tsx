...
const Navbar = () => {
  return (
    <nav className="fixed top-0 w-full h-[70px] flex items-center justify-center z-[99999] bg-dim-white bg-opacity-20">
      <div className="container flex flex-wrap items-center justify-between w-full h-full px-8 backdrop-blur-md ">
